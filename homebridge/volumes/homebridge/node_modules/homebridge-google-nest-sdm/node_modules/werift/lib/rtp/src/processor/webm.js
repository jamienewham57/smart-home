...
class WebmBase {
    constructor(tracks, output, options = {}) {
        ...
        this.builder = new __1.WEBMBuilder(tracks, options.encryptionKey);
        tracks.forEach((t) => {
...
function replaceSegmentSize(totalFileSize) {
    ...
    const resize = [
        ...(0, __1.vintEncode)((0, __1.numberToByteArray)(bodySize, (0, __1.getEBMLByteLength)(bodySize))),
    ];
    const todoFill = 8 - resize.length - 2;
    if (todoFill > 0) {
        resize.push(0xec);
        if (todoFill > 1) {
            const voidSize = (0, __1.vintEncode)((0, __1.numberToByteArray)(todoFill, (0, __1.getEBMLByteLength)(todoFill)));
