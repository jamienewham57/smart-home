...
exports.Characteristic = exports.CharacteristicsTypes = exports.Service = exports.ServicesTypes = void 0;
exports.ServicesTypes = {
    ...
    '00000203-0000-1000-8000-00000237': 'Diagnostics',
    '00000203-0000-1000-8000-0000022A': 'WiFiTransport',
...
exports.Service = {
    ...
    AccessoryRuntimeInformation: '00000203-0000-1000-8000-00000239',
    Diagnostics: '00000203-0000-1000-8000-00000237',
    WiFiTransport: '00000203-0000-1000-8000-0000022A',
...
exports.CharacteristicsTypes = {
    ...
    '0000021E-0000-1000-8000-0000023B': 'ActivityInterval',
    '0000021E-0000-1000-8000-00000246': 'CCAEnergyDetectThreshold',
    '0000021E-0000-1000-8000-00000245': 'CCASignalDetectThreshold',
    '0000021E-0000-1000-8000-00000143': 'CharacteristicValueTransitionControl',
    '0000021E-0000-1000-8000-00000144': 'SupportedCharacteristicValueTransitionConfiguration',
    '0000021E-0000-1000-8000-0000022B': 'CurrentTransport',
    '0000021E-0000-1000-8000-00000138': 'DataStreamHAPTransport',
    '0000021E-0000-1000-8000-00000139': 'DataStreamHAPTransportInterrupt',
    '0000021E-0000-1000-8000-0000023D': 'EventRetransmissionMaximum',
    '0000021E-0000-1000-8000-0000023E': 'EventTransmissionCounters',
    '0000021E-0000-1000-8000-0000024A': 'HeartBeat',
    '0000021E-0000-1000-8000-00000247': 'MACRetransmissionMaximum',
    '0000021E-0000-1000-8000-00000248': 'MACTransmissionCounters',
    '0000021E-0000-1000-8000-00000232': 'OperatingStateResponse',
    '0000021E-0000-1000-8000-0000023C': 'Ping',
    '0000021E-0000-1000-8000-00000244': 'ReceiverSensitivity',
    '0000021E-0000-1000-8000-0000023F': 'ReceivedSignalStrengthIndication',
    '0000021E-0000-1000-8000-0000023A': 'SleepInterval',
    '0000021E-0000-1000-8000-00000241': 'SignalToNoiseRatio',
    '0000021E-0000-1000-8000-00000238': 'SupportedDiagnosticsSnapshot',
    '0000021E-0000-1000-8000-00000242': 'TransmitPower',
    '0000021E-0000-1000-8000-00000243': 'TransmitPowerMaximum',
    '0000021E-0000-1000-8000-00000229': 'VideoAnalysisActive',
    '0000021E-0000-1000-8000-0000022C': 'WiFiCapabilities',
    '0000021E-0000-1000-8000-0000022D': 'WiFiConfigurationControl',
...
exports.Characteristic = {
    ...
    ActivityInterval: '0000021E-0000-1000-8000-0000023B',
    CCAEnergyDetectThreshold: '0000021E-0000-1000-8000-00000246',
    CCASignalDetectThreshold: '0000021E-0000-1000-8000-00000245',
    CharacteristicValueTransitionControl: '0000021E-0000-1000-8000-00000143',
    SupportedCharacteristicValueTransitionConfiguration: '0000021E-0000-1000-8000-00000144',
    CurrentTransport: '0000021E-0000-1000-8000-0000022B',
    DataStreamHAPTransport: '0000021E-0000-1000-8000-00000138',
    DataStreamHAPTransportInterrupt: '0000021E-0000-1000-8000-00000139',
    EventRetransmissionMaximum: '0000021E-0000-1000-8000-0000023D',
    EventTransmissionCounters: '0000021E-0000-1000-8000-0000023E',
    HeartBeat: '0000021E-0000-1000-8000-0000024A',
    MACRetransmissionMaximum: '0000021E-0000-1000-8000-00000247',
    MACTransmissionCounters: '0000021E-0000-1000-8000-00000248',
    OperatingStateResponse: '0000021E-0000-1000-8000-00000232',
    Ping: '0000021E-0000-1000-8000-0000023C',
    ReceiverSensitivity: '0000021E-0000-1000-8000-00000244',
    ReceivedSignalStrengthIndication: '0000021E-0000-1000-8000-0000023F',
    SleepInterval: '0000021E-0000-1000-8000-0000023A',
    SignalToNoiseRatio: '0000021E-0000-1000-8000-00000241',
    SupportedDiagnosticsSnapshot: '0000021E-0000-1000-8000-00000238',
    TransmitPower: '0000021E-0000-1000-8000-00000242',
    TransmitPowerMaximum: '0000021E-0000-1000-8000-00000243',
    VideoAnalysisActive: '0000021E-0000-1000-8000-00000229',
    WiFiCapabilities: '0000021E-0000-1000-8000-0000022C',
    WiFiConfigurationControl: '0000021E-0000-1000-8000-0000022D',
