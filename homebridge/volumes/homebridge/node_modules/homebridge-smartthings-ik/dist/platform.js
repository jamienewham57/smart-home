...
exports.IKHomeBridgeHomebridgePlatform = void 0;
const settings_1 = require("./settings");
const axios = require("axios");
//import { BasePlatformAccessory } from './basePlatformAccessory';
const multiServiceAccessory_1 = require("./multiServiceAccessory");
const subscriptionHandler_1 = require("./webhook/subscriptionHandler");
/**
 * HomebridgePlatform
 * This class is the main constructor for your plugin, this is where you should
 * parse the user config and discover/register accessories with Homebridge.
 */
class IKHomeBridgeHomebridgePlatform {
        ...
        this.api.on('didFinishLaunching', async () => {
            ...
            this.getOnlineDevices().then((devices) => {
                ...
                if (config.WebhookToken && config.WebhookToken !== '') {
                    this.subscriptionHandler = new subscriptionHandler_1.SubscriptionHandler(this, this.accessoryObjects);
    ...
    findSupportedCapability(device) {
        ...
        device.components.forEach(component => {
            if (!found && component.capabilities.find((ca) => multiServiceAccessory_1.MultiServiceAccessory.capabilitySupported(ca.id))) {
                found = true;
            }
        });
        return found;
    }
    createAccessoryObject(device, accessory) {
        // const component = device.components.find(c => c.id === 'main');
        // let capabilities;
        // if (component) {
        ...
        // }
        const acc = new multiServiceAccessory_1.MultiServiceAccessory(this, accessory);
        device.components.forEach(component => {
...
exports.IKHomeBridgeHomebridgePlatform = IKHomeBridgeHomebridgePlatform;
